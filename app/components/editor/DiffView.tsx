  ...
  return (
    <div className={classNames('px-3 py-1 text-sm font-mono flex', getLineClass())}>
      {lineNumber !== undefined && (
        <span className="w-12 text-gray-500 text-right mr-4 flex-shrink-0">{lineNumber}</span>
      )}
            ...
            <div key={filePath} className="mb-6 border border-gray-200 rounded-lg overflow-hidden">
              <div className="bg-gray-100 px-4 py-2 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-xs text-gray-500">{modification.type === 'diff' ? 'Modified' : 'Replaced'}</div>
                </div>
                ...
                {modification.type === 'diff' ? (
                  ...
                  <div className="p-4">
                    <div className="bg-green-50 border border-green-200 rounded p-3">
                      <div className="text-green-800 text-sm font-medium mb-2">File replaced with new content</div>
