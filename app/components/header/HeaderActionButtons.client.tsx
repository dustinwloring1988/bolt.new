    ...
    <>
      <div className="flex gap-2">
        ...
        <div className="relative" ref={deployDropdownRef}>
          <div className="flex border border-bolt-elements-borderColor rounded-md overflow-hidden">
            <Button title="Deploy" onClick={() => setShowDeployDropdown(!showDeployDropdown)}>
        ...
        <div className="relative" ref={integrationsDropdownRef}>
          <div className="flex border border-bolt-elements-borderColor rounded-md overflow-hidden">
            <Button title="Integrations" onClick={() => setShowIntegrationsDropdown(!showIntegrationsDropdown)}>
          ...
          {showIntegrationsDropdown && (
            <div className="absolute top-full right-0 mt-1 bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor rounded-md shadow-lg z-50 min-w-48">
              ...
              >
                ...
                <div
                  className={`w-2 h-2 rounded-full ${
                    githubConnected === true ? 'bg-green-500' : githubConnected === false ? 'bg-red-500' : 'bg-gray-400'
                  }`}
                />
              </button>
            </div>
        ...
        <div className="relative" ref={exportDropdownRef}>
          <div className="flex border border-bolt-elements-borderColor rounded-md overflow-hidden">
            <Button title="Export" onClick={() => setShowExportDropdown(!showExportDropdown)}>
      ...
      <CheckpointManager isOpen={showCheckpoints} onClose={() => setShowCheckpoints(false)} />
    </>
  );
}
